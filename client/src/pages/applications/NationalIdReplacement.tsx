...
export default function NationalIdReplacement() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      Object.keys(data).forEach(key => {
        if (!['photo', 'oldDocument', 'policeReport'].includes(key)) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-3xl font-bold mb-2">National ID Replacement</h1>
        <p className="text-gray-600 mb-6">Replace your lost, stolen, damaged, or incorrect National ID</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1">Old National ID (if available)</label>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Required for lost or stolen IDs</p>
            </div>
          </div>
